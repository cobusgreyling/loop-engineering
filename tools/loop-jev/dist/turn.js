...
import { heuristicGuard, inputBattery, routeGuard, } from './guard.js';
import { heuristicRoute, LOW_CONFIDENCE, routeQuestions, TIERS, } from './route.js';
...
export async function assessTurn(input, opts = {}) {
