...
export function retrieveQuestions(passages) {
    const criteria = {};
    const questions = {
        which: choice({
...
export async function retrieveContext(input, opts = {}) {
